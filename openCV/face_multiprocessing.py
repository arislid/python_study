...
my_image = fik.load_image_file("./my sample/minji.jpg")
my_face_encoding = fik.face_encodings(my_image)[0]
            ...
            while True:
                ...
                for t in range(0,threads):
                    if parent_p[t].poll():
                        ...
                        match = fik.compare_faces([my_face_encoding], face_encodings_cam[0])
                        name = "Unknown"
